...
Underwriting starts by separating 2 instruments that are routinely conflated. The Investor Visa is an immigration route requiring a qualifying investment held for the life of the permit; the flat tax is an income-tax regime for new residents. Neither confers the other, and each has its own test.
