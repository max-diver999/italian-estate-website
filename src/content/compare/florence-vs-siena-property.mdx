...
To compare Florence versus Siena properly, hold the holding period and the tax basis constant on both sides. Take three closed sales from the same OMI quartiere as the price anchor, then work the 21% gross-to-net spread through with a commercialista before releasing a deposit, because a Siena exit is priced against far fewer comparable transactions than a Florence one.
