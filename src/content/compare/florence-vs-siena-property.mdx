...
Florence averages €4,737/m² versus Siena at roughly €2,800-3,500/m². Florence suits capital growth and international liquidity; Siena suits yield-focused buyers with lower entry and fewer centro STR bans than Florence UNESCO core.. Three closed OMI sales in the same micro-district beat any portal average, and they should be read against whether a short-let licence is available for that exact address. Before the compromesso, put the visura catastale, the conformità file and three years of spese in front of your own lawyer, and press hardest on whether a short-let licence is available for that exact address.
