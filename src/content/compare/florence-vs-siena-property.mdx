...
Both cities constrain renovation through heritage protection, and in each the approval path rather than the builder decides the schedule. Foreign buyers should establish the Soprintendenza position before the offer, because clearance on protected fabric commonly adds 12 to 18 months before permitted works may lawfully begin.
...
This page holds the comparison between the 2 cities; the tax and purchase guides hold the bands. Foreign buyers should follow the links for any figure, since each number lives in 1 owning page and is dated there rather than duplicated across every page that mentions it.
