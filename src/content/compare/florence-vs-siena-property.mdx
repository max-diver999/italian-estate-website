...
To compare Florence versus Siena properly, hold the holding period and the tax basis constant on both sides. Take three closed sales from the same OMI quartiere as the price anchor, then Have a commercialista convert the gross yield into a net one, applying IMU, cedolare secca and honest vacancy, before any deposit is released.
...
Florence returns 2.5-3.5% gross on long leases at about €4,750 per sqm in the Oltrarno. Siena returns 3-4% at €3,800-6,500, helped by Palio-season short-let spikes that flatter the annual figure. Neither is an income asset, and heritage works budgets move the outcome more than the entry price does.
...
## What short-term rental restrictions apply in each city?

Both cities require the national CIN plus regional registration and Alloggiati Web guest filing. The divergence is municipal: Florence has closed new short-let registrations city-wide since May 2026, while Siena still permits them inside the wall ring subject to density rules. That single difference decides which strategies remain available.
...
Florence typically fits foreign buyers who value international resale depth and can work within restricted short-let licensing. Siena fits those buying scarcity in a compact UNESCO centro, accepting a thinner resale pool, a tourism-weighted calendar and a holding period measured in years rather than months.
...
Florence's Oltrarno runs €4,750 per sqm for 2.5-3.5% gross on long leases. Siena's centro storico runs €3,800-6,500, where Palio-season short-let spikes flatter the headline and IMU compresses net toward 3-4%. On €350,000-700,000 tickets neither is an income asset; the difference is which brand carries the exit.

Florence averages €4,737/m² versus Siena at roughly €2,800-3,500/m². Florence suits capital growth and international liquidity; Siena suits yield-focused buyers with lower entry and fewer centro STR bans than Florence UNESCO core.. Track three OMI-quartiere closed sales in the same micro-district rather than portal asking averages, and read them alongside whether a short-let licence is available for that exact address. Confirm the visura catastale, the conformità position and three years of condominium spese with an independent avvocato before the compromesso, paying particular attention to whether a short-let licence is available for that exact address.
...
## How do renovation costs and heritage rules compare?

Both cities constrain renovation through heritage protection, and in each the approval path rather than the builder decides the schedule. Buyers from abroad should establish the Soprintendenza position before the offer, because clearance on protected fabric commonly adds 12 to 18 months before permitted works may lawfully begin, and that delay is carried by the buyer rather than the seller.
...
Florence is the more liquid of the two by a wide margin, because its buyer pool is genuinely international and continuously replenished. Siena's market is smaller and more specialised, so foreign buyers there should plan a longer sale window and price against a narrower set of comparable transactions.
...
Florence typically suits foreign buyers who want depth of international resale demand and can accept restricted short-let licensing. Siena suits those buying scarcity in a smaller UNESCO centro, with a more tourism-weighted calendar, a thinner resale pool and a correspondingly longer realistic holding period.
...
The investment verdict refers to choosing Florence for maximum foreign enquiry recognition on exit above €500,000 while Siena suits medieval prestige at slightly lower per sqm with Palio-season income offset when hold period exceeds 8 years and soprintendenza filings are budgeted, per buyer scenario screening in Q2 2026.
...
This page holds the comparison between the two cities; the tax and purchase guides hold the bands. Foreign buyers should follow the links for any figure, since each number lives in 1 owning page and is dated there rather than duplicated across every page that mentions it, which is why figures here appear in short form.

Regional pages here carry the short form of each tax figure, while the specialist tax guides own the bands themselves. Foreign buyers comparing these two Tuscan cities should read this page for the market difference and follow the links for the numbers, which are updated in 1 place rather than restated everywhere.

Hub navigation matters when foreign buyers cross-read area guides, tax frameworks, and national investment pillars before compromesso on Florence versus Siena tickets with 10-15% non-resident closing stacks in Q2 2026. Model the gross-to-net gap with a commercialista — IMU, cedolare secca at 21% or 26%, spese and void weeks — before the compromesso deposit moves.

This page belongs to the Italian Estate research hub. The natural next reads are [Italy Property Investment Guide](/guides/italy-property-investment-guide/), [Tuscany Property Investment Guide, Prestige Rea](/guides/tuscany-property-investment-guide/), [Florence Real Estate](/areas/florence/), [Siena Property Investment, Historic Centre & Tu](/areas/siena/), [Chianti Real Estate Investment, Tuscan Vineyard](/areas/chianti/).
...
Resale and buyer-profile benchmarks show Florence maintaining stronger international portal depth for US and UK lifestyle buyers while Siena suits owners accepting slower 12-18 month resale on centro tickets priced for German and Dutch repeat visitors. STR licensing in Florence UNESCO core faces new licence restrictions while Siena comune enforces CIN and SCIA with building-level tourist-use bans on sensitive palazzi blocks. Italian Estate recommends Florence for maximum foreign enquiry recognition on exit above €500,000; Siena for medieval prestige at slightly lower per sqm with Palio-season income offset when hold period exceeds 8 years and renovation budgets include soprintendenza filings on pre-1800 stock.Underwriting here starts with the visura catastale and the conformità position, then turns to whether a short-let licence is available for that exact address.

{/* geo-cit:florence-vs-siena-property-cit-2 */}

- **This page owns:** the structural comparison between 2 Tuscan cities and how their heritage regimes differ.
- **Defers to the tax guides for:** IMU bands, the 21% and 26% cedolare secca rates, and the 10% to 15% closing stack.
- **Read next:** the individual [Florence](/areas/florence/) area page before pricing a centro offer.
