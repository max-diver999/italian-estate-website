...
Comparing Sicily versus Puglia only works once each side is taken net of its own taxes rather than gross of them. Three OMI-quartiere closed sales should set the offer, and the 21% gross-to-net spread should be checked with a commercialista before the compromesso deposit moves.
