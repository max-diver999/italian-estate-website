...
## What should investors know about investment performance comparison yield gap analysis in Sicily versus Puglia?

Any yield gap between the 2 regions collapses once works are included. Any non-resident buyer should compare net yield after restoration capex, annual IMU running 0.86% to 1.06% of cadastral value and 21% cedolare secca, rather than gross yield on an asking price that assumes a finished property.
...
Entry prices and access compare in Sicily versus Puglia here means underwrites Sicily versus Puglia at €100 after IMU, 21% cedolare secca, and realistic vacancy assumptions reviewed with commercialista before lease registration. Request three OMI-quartiere closed sales before offer anchoring. Model 21% gross-to-net spread with commercialista before compromesso deposit authorization.

Commute and airport access on sicily vs puglia property shapes tenant pools: walkable services and rail links command premium rents versus car-only fringe stock on identical sqm bands.
...
EU citizens buy sicily vs puglia property stock on equal terms with Italians; non-EU reciprocity buyers need codice fiscale, notary-led rogito, and 10-15% closing stacks on second homes reviewed before deposit.
...
## What should investors know about short-term rental regulations and compliance framework in Sicily versus Puglia?

buyer scenario work on what should investors know about short-term rental regulations and compliance framework in sicily versus puglia means evaluating Sicily versus Puglia at 21% and 26% bands with visura catastale review and independent avvocato sign-off before compromesso deposit wires to notaio escrow on non-resident second-home purchases.
...
buyer scenario work on how does resale liquidity compare in sicily versus puglia means evaluating Sicily versus Puglia at €1,168 and €1,422 bands with visura catastale review and independent avvocato sign-off before compromesso deposit wires to notaio escrow on non-resident second-home purchases.
...
Sicily vs Puglia property comparison: €1,168/m² vs €1,422/m², yields 6-10% interior vs 5-8%, liquidity, STR, buyer profiles, infrastructure 2026. Under this topic, track three OMI-quartiere closed sales in the same micro-district rather than portal asking averages alone. Confirm visura catastale, conformità edilizia, and condominium spese with independent avvocato review before compromesso deposit wires to notaio escrow accounts.
...
The framework starts from the works budget in both regions, because restoration cost varies far more than purchase price. Foreign buyers should establish the permit position, price the capex from a geometra survey, and only then compare what is left against the asking prices in each market.
...
The regional verdict means income-first buyers under €350,000 should model Puglia masseria STR at 5-7% gross against Sicily Taormina trophy stock at 4-6% with higher cadastral regularisation risk on rural baglio conversions before wire to notaio escrow accounts, per buyer scenario screening in Q2 2026.
...
Both regions are restoration markets, but the binding constraint differs. Foreign buyers in Puglia most often meet pool SCIA filings and trulli cadastral regularisation, while in Sicily the recurring items are seismic classification and heritage clearance on baroque centro stock.
