...
Feel and Bliss extend the UpTown masterplan with complementary massing and amenity packages. Buyers interested in larger unit selection or later completion may prefer waiting for Feel and Bliss launches if Inspire inventory tightens on popular floors.
...
| Feel | Residential tower | TBC | Pipeline |
| Bliss | Residential tower | TBC | Pipeline |
