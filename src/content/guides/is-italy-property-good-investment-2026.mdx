...
Four numbers frame the 2026 case: gross rental yields around 4.3%, capital appreciation near 2.6%, blended total returns of about 6.9%, and 719,578 national transactions in 2024 underpinning the liquidity assumption. Foreign buyers take roughly 15.2% of the market, and the price-to-income ratio sits near 7.2x against a European average of 8.1x, which is the clearest evidence that Italian housing is not overpriced relative to incomes.
