...
Italy property numbers for 2026 typically mean 4.3% rental yields, 2.6% capital appreciation, and 6.9% blended total returns when 719,578 transactions in 2024 anchor liquidity assumptions on national data. Thesis tables show foreign buyer share near 15.2% with price-to-income ratios near 7.2x versus 8.1x European averages.
...
Italy tax and financing structure typically means 9% second-home registration, 21-43% rental bands, IMU near 0.86-1.06%, and mutuo LTV at 50-80% for EU citizens versus 50-60% for many non-EU files in 2026. Notes Superbonus energy paths and SRL wrappers above €750,000 deployed capital.
