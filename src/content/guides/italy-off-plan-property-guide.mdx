...
Italian off-plan due diligence requires a valid permesso di costruire or SCIA covering your exact unit before any caparra moves, with plans matching cadastral filings within 2-5% tolerance on sold sqm. Geometra review typically takes 5-10 business days once the developer delivers the full permit pack.
...
Developer due diligence on Italian off-plan means reviewing three years of bilancio, visura camerale, and fideiussione covering at least 100% of compromesso caparra before milestone two. MORE Group underwriting matches SAL photos to site progress on every Navigli and Ostuni off-plan file we review.
...
After off-plan basics, foreign buyers typically need three companion guides covering legal entry, diligence, and all-in costs before wiring a 10-20% caparra to escrow. MORE Group maps 156 off-plan enquiries in Q2 2026 to these three URLs in 82% of shortlist requests.
