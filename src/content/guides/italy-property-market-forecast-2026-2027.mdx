...
Italy saw 719,578 residential transactions in 2024 and an estimated 766,756 in 2025 (+6.4%). Regional foreign-buyer share swings widely around that, so it frames the market rather than any single comune.
...
What is the overall italy property market forecast 2026: the 2026 baseline involves 719,578 baseline transactions, €5.5B foreign capital, €632,000 average tickets, and 10-15% closing stacks, with gross yields ranging 2-10% by region before IMU and cedolare secca apply to rental income streams.
...
| 2026 forecast signal | National range | Investor note |
|---|---|---|
...
Volume forecasts are less useful to a foreign buyer than the fixed costs that surround any transaction. Whatever the direction of travel, the an all-in cost of 10% to 15% entry stack and the 5-year capital gains window apply, and together they set the minimum hold regardless of the cycle.
...
- **Closing costs:** budget an all-in cost of 10% to 15% on a non-resident second home before any forecast matters.
- **Annual carry:** IMU at 0.86% to 1.06% of cadastral value, set by the comune.
- **Letting income:** 21% on the first short-let unit and 26% on the second, with a business presumption from the third.

- Budget an all-in cost of 10% to 15% on a non-resident second home before any forecast matters.
- IMU runs 0.86% to 1.06% of cadastral value annually, set by the comune.
