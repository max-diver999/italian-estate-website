...
Forecasts age faster than the rules behind them, so the pages below carry the figures this one only summarises. Foreign buyers should follow those links for any tax band or transaction cost, since each is maintained and dated in 1 owning guide.
