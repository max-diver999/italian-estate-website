---
title: "Italy Property Market Forecast 2026-2027 for Buyers"
...
readingTime: 10
featured: false
heroImage: "https://pub-2855c73eea384110b510f25966292c37.r2.dev/more-group/italy/guides/italy-property-market-forecast-2026-2027/hero.webp"
...
faq:
  - question: "What is the property market forecast for Italy in 2026?"
    answer: "This desk projects nominal growth of 1.5% to 3.5% nationally in 2026, concentrated in Milan, Rome and the prime lake and Tuscan markets. That is an estimate, not an official series. The recorded starting point is 766,757 sales in 2025, growth of 6.4%."
...
**Quick answer:** Italy enters 2026 after 766,757 residential sales in 2025 (+6.4%). This desk projects nominal price growth of 1.5–3.5% nationally, with Milan, Rome and prime lake markets ahead of the average, and mortgage rates settling around 3.2–3.6% after ECB cuts.
...
<TldrBlock text="Italy closed 2025 with 766,757 sales, growth of 6.4%, so any 2026 forecast starts from a market that is already recovering rather than one waiting to. Our own projection is nationwide nominal growth of 1.5% to 3.5% and mortgage rates settling between 3.2% and 3.6%. Those two figures are estimates and are labelled as such throughout." />

The starting point is settled rather than projected: the Agenzia delle Entrate recorded 766,757 residential sales in 2025 against 719,578 in 2024. Everything below is an attempt to extend that line, and it should be read with the confidence appropriate to extrapolation. Yield assumptions in particular belong on OMI quartiere data rather than on portal asking peaks.

## What is the overall Italy property market forecast 2026?

Three things about 2026 can be stated with reasonable confidence, and a fourth cannot. Volume enters the year above 766,000 sales and rising. Financing has loosened, with bank lending up about a quarter in 2025. The cost of buying has not moved, so the closing stack still governs the minimum sensible hold. What cannot be stated is the price path, because it turns on rate decisions nobody at this desk can see.
...
Whatever the cycle does, three habits decide the outcome of an individual purchase more than the forecast does. Commission an independent avvocato and geometra before any compromesso deposit. Underwrite on net cash flow after tax rather than on a portal gross band. Argue the offer against three closed sales in the same OMI quartiere, not against a national average.

| Signal | 2026 view | Standing |
|---|---|---|
| Transaction volume | Growth continues, at a slower rate than the 6.4% of 2025 | Projection |
| Nominal price growth | 1.5% to 3.5% nationally, wider in prime micro-markets | Projection |
| Foreign buyer share | About 5.1% of transactions, concentrated in a handful of communes | Recorded |
| Closing stack, non-resident | 10% to 15% all-in, unchanged | Published band |

## How will regional property prices perform across Italy in 2026 and 2027?

Regional averages conceal more than they reveal over a 2-year horizon, because a single region spans historic centres and peripheries that behave differently. Foreign buyers should read any regional figure as context and price the actual offer against 3 OMI-quartiere closed sales instead.
...
Rate projections matter less to a foreign buyer than the terms actually offered to a non-resident. Loan-to-value is typically capped below resident levels, pricing follows the property's location rather than the borrower's country of residence, and a codice fiscale is required before any application can proceed.
...
Volume forecasts are less useful to a foreign buyer than the fixed costs that surround any transaction. Whatever the direction of travel, the 10% to 15% entry stack and the five-year capital gains window both apply, and together they set the minimum hold regardless of the cycle.

Transaction volume is the clearest available proxy for liquidity, and the recent path is not the one usually described. Sales peaked above 780,000 in 2022, fell to roughly 710,000 in 2023 as the European Central Bank raised rates, then turned. The Agenzia delle Entrate recorded 719,578 sales in 2024, growth of 1.3%, and 766,757 in 2025, growth of 6.4%. The market did not contract through 2024 and 2025; it recovered, and the recovery was financed rather than paid in cash, with about 334,000 purchases carrying a mortgage and bank lending up roughly a quarter year on year.
...
The table below sets the recorded volumes from 2022 to 2025 against projections for 2026 and 2027. The first four rows are Agenzia delle Entrate figures. The last two are this desk's projections and carry no official standing:

| Calendar year | Residential transactions (NTN) | Year-on-year change | Basis |
|:--- |:--- |:--- |:--- |
| 2022 | about 781,000 | +10.2% | Recorded |
| 2023 | about 710,000 | -9.2% | Recorded |
| 2024 | 719,578 | +1.3% | Recorded, Agenzia delle Entrate |
| 2025 | 766,757 | +6.4% | Recorded, Agenzia delle Entrate |
| 2026 | 780,000 to 800,000 | +2% to +4% | Projection, not official |
| 2027 | 790,000 to 820,000 | +1% to +3% | Projection, not official |

*Recorded figures: Agenzia delle Entrate, Osservatorio del Mercato Immobiliare, Rapporto Immobiliare 2026 and 2025. Projections are this desk's own and should be read as such. We do not publish a forecast of foreign buyer share, because no official series measures it: the reliable anchor is that foreign buyers accounted for about 5.1% of residential transactions, concentrated in a small number of communes rather than spread across the country.*

## Which Italian locations offer the highest rental yields and capital appreciation?

High gross yield and strong capital appreciation seldom occur in the same Italian comune, and conflating them is the common error. Southern cities lead gross yield because entry prices are low, while northern employment centres lead appreciation on tighter yields at materially higher entry costs.
...
- Anchor the offer on three closed sales from the same OMI quartiere.
...
The principal risks in Italy are documentary rather than market-driven, which means a buyer can control them. Foreign buyers most often lose money to conformità gaps against the cadastral plan, condominium prohibitions on tourist use, and works budgets set from a listing rather than a geometra survey.
...
Forecast-driven strategy is worth less than structural positioning over a 2-year horizon. Foreign buyers should size entry against the an all-in cost of 10% to 15% closing stack and the 5-year capital gains window, because those two fixed costs dominate any plausible price movement across such a short period.

Four moves are defensible on the current data and one common move is not. Price against registered deeds rather than portal asking figures, since the spring-to-winter gap runs 8-12% in most markets and wider where comparables are thin. Settle the letting question at address level before the price is negotiated, because a licence freeze or a condominium ban removes the higher-yielding route outright. Model a seven to ten year hold, since the plusvalenza rule taxes a gain at 26% inside five years and southern resale windows run 18 to 36 months. And pair a scarcity asset with an income asset so the two halves do not go quiet in the same months. The move that is not defensible is treating aggregate national appreciation near 2.6% as applicable to any specific micro-market.

## Related Reading

Forecasts age faster than the rules behind them, so the pages below carry the figures this one only summarises. Non-resident buyers should follow those links for any tax band or transaction cost, since each is maintained and dated in one owning guide.
...
Three fixed costs outrank any forecast in deciding whether a purchase works, and each has its own page rather than a summary here. Entry is covered in [what buying in Italy costs to complete](/guides/cost-of-buying-property-italy/). Annual carry, principally IMU, is set out in [Italian property taxes for foreign buyers](/guides/italy-property-taxes-foreign-buyers-guide/). Letting income and the cedolare secca rates that apply to it are in [how to calculate rental yield in Italy](/guides/how-to-calculate-rental-yield-italy/). One point belongs here because it interacts directly with a forecast: a sale within five years of purchase is liable to capital gains, which sets a floor under the hold period independent of where prices go.
