...
Forecast-driven strategy is worth less than structural positioning over a 2-year horizon. Foreign buyers should size entry against the an all-in cost of 10% to 15% closing stack and the 5-year capital gains window, because those 2 fixed costs dominate any plausible price movement across such a short period.
