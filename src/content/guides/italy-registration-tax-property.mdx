...
British and Irish buyers search for **stamp duty in Italy** and find nothing under that name, because Italy does not use it. The tax that does the same job is the **imposta di registro**, the registration tax this page describes. If you have bought in the UK, treat the two as equivalents and then note where they stop behaving alike, because the differences change the arithmetic in your favour more often than not.
