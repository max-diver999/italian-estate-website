...
Registration tax on Italian property in 2026 means Imposta di Registro at 2% for qualifying Prima Casa buyers or 9% for second homes on cadastral value under prezzo-valore rules, with €1,000 minimum payments on private sales. Closing models add 10% to 12% stacked transaction costs beyond the notary line. Use the recap table before rogito.
