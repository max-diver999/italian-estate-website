---
title: "Italy Registration Tax: Stamp Duty Equivalent 2026"
description: "Italy has no stamp duty. The imposta di registro does that job, at 2% or 9% of cadastral value rather than price. Rates, mechanics and worked examples."
pubDate: 2026-06-15
...
readingTime: 10
featured: false
heroImage: "https://pub-2855c73eea384110b510f25966292c37.r2.dev/more-group/italy/guides/italy-registration-tax-property/hero.webp"
...
Registration tax in Italy is charged on cadastral value rather than the price paid when buying from a private seller, which is the single most misunderstood point among the [costs of buying](/guides/cost-of-buying-property-italy/) for foreign buyers. A second home attracts 9%, and [prima casa relief](/guides/italy-prima-casa-vs-second-home-tax/) brings that down to 2% where the conditions are met.
...
<TldrBlock text="TL;DR: The Italian property registration tax (Imposta di Registro) is 2% for primary residences (Prima Casa) and 9% for second homes, calculated on the property's cadastral value rather than the purchase price for private sales. How far that value sits below the market price, and how to find it, is worked through in [cadastral value against market price](/guides/cadastral-value-vs-market-price-italy/), and the rest of the transaction stack in [the closing costs breakdown](/guides/italy-property-closing-costs-breakdown/). Developer sales are subject to VAT (4% to 22%) instead. Buyers must meet strict residency and cadastral criteria to qualify for the reduced 2% rate." />

| Registration scenario | 2026 rate |
|---|---|
...
Imposta di registro is charged at 2% for a qualifying prima casa buyer and 9% for a second home, and (crucially) on the cadastral value rather than the price paid, under the prezzo-valore rules that apply to private resales. Where the seller is a VAT-registered developer, IVA replaces it.

A minimum payment of €1,000 applies on private sales. That base difference is why the tax line is usually far smaller than buyers expect.
...
## Is this the Italian equivalent of stamp duty?

British and Irish buyers search for **stamp duty in Italy** and find nothing under that name, because Italy does not use it. The same translation problem produces six other recurring errors, collected in [what English guides get wrong](/guides/english-guides-wrong-italian-property/). The tax that does the same job is the **imposta di registro**, the registration tax this page describes. If you have bought in the UK, treat the two as equivalents and then note where they stop behaving alike, because the differences change the arithmetic in your favour more often than not.

**It is charged on the cadastral value, not on the price.** UK stamp duty land tax is charged on what you pay. Italian registration tax on a resale from a private seller is charged on the cadastral value under the prezzo-valore mechanism, which is typically well below the purchase price. A 9% headline rate on a cadastral value can land below a 5% rate on a market price.

**It is banded by use, not by price.** SDLT rises through price bands. Italian registration tax turns on whether the property is a prima casa, at 2%, or a second home, at 9%, with a minimum of EUR 1,000 either way. The price only matters through the cadastral value it sits above.

**New builds leave the system entirely.** Buying from a developer means VAT rather than registration tax, at 4% for a prima casa, 10% for a second home and 22% on luxury categories, with registration, mortgage and cadastral taxes reduced to fixed amounts.

**There is no surcharge for owning other property.** The UK's additional dwelling surcharge has no Italian counterpart. What determines the rate is whether this purchase qualifies as your prima casa in Italy, which depends on residency and on not already holding a prima casa in the same comune.

Buyers coming from the UK will find the wider comparison, including the inheritance tax position under the 1966 convention, in [British buyers in Italy](/guides/italy-property-for-uk-buyers/), and the relocation side in [moving to Italy from the UK](/guides/moving-to-italy-from-uk/).

## How is the registration tax calculated for private sales in Italy?

For private sales, the registration tax is calculated using the prezzo-valore system established in 2006, reserved for [individual buyers rather than companies](/guides/buying-property-italy-through-company/). The notary applies the 2% or 9% tax rate to the cadastral value, which is determined by multiplying the cadastral income by a revaluation factor of 1.05 and a multiplier of 110 or 120.
...
Italy Registration Tax Property Rates and Minimums
...
Additionally, luxury properties may face higher annual property taxes (*Imposta Municipale Unica*, or [IMU](/guides/imu-property-tax-italy/)). While non-luxury primary homes are generally exempt from IMU, luxury primary homes (A/1, A/8, A/9) remain subject to annual IMU payments, calculated using municipal tax rates applied to the revalued cadastral income. For high-net-worth individuals, this makes a thorough cadastral search during the due diligence phase absolutely vital, as a property that appears to be a standard villa might be registered as an A/8 luxury property, significantly increasing both immediate purchase taxes and ongoing ownership costs.
...
## What should buyers remember about registration tax in 2026?

Three things. The rate is 2% or 9% depending on prima casa eligibility, not on nationality. The base is the cadastral value under prezzo-valore, not the declared price, with a €1,000 minimum on private sales. And registration tax is one line among several: the full closing stack runs 10-12% once notary fees, agency commission and the cadastral and mortgage duties are added.

| Rate path | 2026 rule |
|---|---|
| Prima Casa (resident) | 2% on cadastral value |
| Second home / non-resident | 9% on cadastral value |
| Developer purchase | 4% to 22% VAT on price |
| Minimum registration tax | €1,000 |

- Request prezzo-valore clauses in the deed for private resale.
- Verify A/1, A/8, A/9 luxury categories before claiming 2%.
- Register residency within 18 months or face 7% clawback plus penalties.
