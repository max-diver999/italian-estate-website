...
Imposta di registro is charged at 2% for a qualifying prima casa buyer and 9% for a second home, and — crucially — on the cadastral value rather than the price paid, under the prezzo-valore rules that apply to private resales. Where the seller is a VAT-registered developer, IVA replaces it. A minimum payment of €1,000 applies on private sales. That base difference is why the tax line is usually far smaller than buyers expect.
