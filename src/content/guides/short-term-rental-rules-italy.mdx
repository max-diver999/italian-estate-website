...
Regulation (EU) 2024/1028 applies from 20 May 2026 and changes what platforms know about hosts. Monthly income reporting to the Agenzia delle Entrate, CIN verification before a listing can activate, and automatic delisting when a code expires. For non-resident owners the practical effect is that Italian income becomes visible to Italy by default.
...
Short-let rules change at 3 levels: national registration, comune policy and the condominium regolamento. The guides below carry the surrounding tax and purchase detail, and foreign buyers should read them alongside this page rather than treating any single summary as complete.
