...
Missing the 18-month residency deadline costs the 7-point difference between the 2% and 9% registration tax on the cadastral value, a 30% administrative penalty on that difference, and statutory interest running from the date of the rogito. On a typical cadastral base that combination frequently exceeds the original saving. Declaring prima casa on an intention you are not certain of is therefore an expensive way to defer a decision.
