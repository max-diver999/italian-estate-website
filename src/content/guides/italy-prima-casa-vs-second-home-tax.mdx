---
title: "Italy Prima Casa vs Second Home Tax (2026)"
...
faq:
  ...
  - question: "What happens if I fail to register residency within 18 months of a Prima Casa purchase?"
    answer: "If you fail to meet the 18-month residency deadline, you must pay the difference between the two% and 9% registration tax, plus a 30% penalty and interest to the Agenzia delle Entrate."
...
**Analysis:** Remote buyers who remain tax-resident abroad should underwrite the 9% second-home stack from day one rather than claim Prima Casa without immigration clearance.
...
**Analysis:** Match rogito tax election to immigration facts before caparra wire; claiming 2% without visa capacity triggers retroactive 7% clawback plus 30% penalty on cadastral value.
...
Three conditions govern the relief. Register your primary residence with the local Anagrafe within 18 months of the rogito; expect a municipal police inspection to verify occupancy, usually within about 45 days of registration; and own no other Italian home bought with prima casa benefits, unless that earlier property is sold within 12 months.

Nationality is irrelevant — a non-EU buyer who meets the residency test qualifies on the same terms as an Italian.

| Requirement | Prima Casa | Seconda Casa |
|:--- |:--- |:--- |
| Anagrafe deadline | 18 months from rogito | Not required |
| Vigili Urbani inspection | Within 45 days of filing | Not required |
| Residency-eligible visa (non-EU) | Required before 2% rate | Not required |
...
Missing the 18-month residency deadline costs the 7-point difference between the 2% and 9% registration tax on the cadastral value, a 30% administrative penalty on that difference, and statutory interest running from the date of the rogito. On a typical cadastral base that combination frequently exceeds the original saving.

Declaring prima casa on an intention you are not certain of is therefore an expensive way to defer a decision.

| Penalty line | Typical amount | Trigger |
|:--- |:--- |:--- |
| Tax difference (private sale) | 7% of cadastral value | Missed 18-month residency |
| Administrative penalty | 30% of tax difference | Agenzia delle Entrate audit |
| Ravvedimento operoso | Penalty cut to under 3% | Self-declare before deadline |
...
- **Red flag checklist:** confirm visa path before 2% rate at notary

Before signing the final deed, review the [compromesso Italy property contract](/guides/compromesso-italy-property-contract/) timeline against your Anagrafe filing plan.
...
Three cadastral categories are excluded outright: A/1 stately homes, A/8 villas and A/9 castles and palaces of historic merit. These pay 9% registration tax and full IMU even where residency is genuine — which matters on Tuscan and Lake Como trophy listings marketed as primary homes.

| Category | Property type | Prima Casa eligible |
|:--- |:--- |:--- |
| A/1 | Stately homes | No |
| A/8 | Villas with gardens | No |
| A/9 | Castles and palaces | No |
| A/2 to A/7 | Standard residential | Yes if residency met |
...
It is highly common for international buyers to purchase beautiful, historic properties in regions like Tuscany, Umbria, or Lake Como, assuming they can claim the two% registration tax rate. However, if the property is registered as an A/8 villa or an A/1 stately home, the tax bill will be more than four times higher than expected. Therefore, verifying the cadastral category of the property through a formal cadastral search (visura catastale) before signing any preliminary contract is a mandatory step in the due diligence process.

## How Can International Buyers Optimize Their Italian Property Purchase?

The choice is rarely close once the whole position is modelled. Seconda casa at 9% costs about €9,030 more on a €115,500 cadastral base, which is cheap against the worldwide IRPEF exposure that Italian tax residency brings. Where prima casa genuinely fits, the Anagrafe registration has to complete within 18 months.

- Elective Residence Visa: passive income proof before rogito at 2% registration rate
- Flat tax regime: 300,000 euros annual substitute on foreign income for qualifying new residents transferring from 2026
- Seconda Casa default: 9% registration plus IMU near 2,100 euros on 1,200 euro rendita bases

| Path | Registration (private resale) | Global tax exposure |
|:--- |:--- |:--- |
| Prima Casa plus ERV | 2% on cadastral value | Italian worldwide IRPEF risk |
| Seconda Casa holiday | 9% on cadastral value | Home-country tax on Italian rent only |
...
**Insider tip:** Independent avvocato review before compromesso deposit beats agency reassurance; visura catastale and conformita gaps surface only after wire transfers if skipped.
