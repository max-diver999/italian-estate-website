...
$$\text{Gross Rental Yield} = \left( \frac{\text{Gross Annual Rental Income}}{\text{Property Purchase Price}} \right) \times 100$$
...
$$\text{Gross Rental Yield} = \left( \frac{21,000}{350,000} \right) \times 100 = 6.0\%$$
...
$$\text{Net Rental Yield} = \left( \frac{\text{Gross Annual Rental Income} - \text{Total Operating Expenses} - \text{Annual Taxes}}{\text{Total Acquisition Cost}} \right) \times 100$$
