...
Positano two-bedroom sea-view apartments trade in the €800,000-1,800,000 band and let at €350-650 a night before fees through July and August, provided the terrace is compliant. Gross yields land at 2.5-4% on a long lease or 3.5-5% under short-let management. Vincolo clearance has to be verified before any terrace capex is budgeted. Gross yields often land at 2.5% to 4% long-term or 3.5% to 5% STR with management. Positano shortlists verify vincolo clearance before terrace capex budgets.
...
July and August produce 45-55% of annual gross revenue on managed Positano portfolios, and November to March frequently falls below 20% occupancy without long-stay marketing. That is the single most misrepresented figure on this coast: underwrite 120-140 rentable nights rather than 280 peak-priced ones, and separate peak-month share from shoulder revenue before comparing listings. Underwriters model 120 to 140 rentable nights, not 280 peak-priced nights. Seasonality tables separate peak-month share from shoulder revenue before ranking listings.
...
Frana zoning under the PAI maps makes a geotechnical relazione geologica a precondition on any terrace villa, and retaining walls can run 8-12% of value in annual maintenance. The SS163 cliff road faces winter closure risk of two to five days at a time, which interrupts short-let check-ins. No slope ticket should proceed without drainage inspection reports. SS163 cliff roads face winter closure risk affecting STR check-ins for 2 to 5 days. Do not allow slope tickets without drainage inspection reports attached.
...
Three Campanian options at very different prices. Cliffside coast stock trades €4,500-10,000 per sqm for 2.5-5% gross; Capri prime reaches €8,000-15,000 with ferry-only access and 2.5-4%; the Sorrento peninsula runs €3,500-6,000 with the mildest seasonality of the three. Ultra-trophy mandates belong on Capri, yield-aware lifestyle capital in Sorrento. Sorrento peninsula bands run €3,500 to €6,000 per sqm with moderate seasonality. Route ultra-trophy mandates to Capri and yield-aware lifestyle capital to Sorrento.
