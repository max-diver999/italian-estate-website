...
Two rates and one exception govern the purchase. A primary residence bought from a private seller attracts registration tax at 2% of the cadastral value; a second home pays 9% on the same base. Where the seller is a VAT-registered developer and the building is under five years old, IVA replaces registration tax instead. Non-resident foreign buyers almost always follow the 9% path, because prima casa relief requires transferring residence within 18 months of the rogito.
...
In favour: a land registry that gives genuinely reliable title, and prima casa relief worth about seven percentage points of registration tax to anyone who will actually move. Against: an upfront stack of 10-15% for a foreign second-home buyer, and annual IMU plus compliance lines that compress the net yield. Long-run appreciation in established regions has run around 2-4% — enough to absorb the entry cost over a full hold, not over three years.
...
Five guides complete the purchase-cost picture: IMU for the annual charge, due diligence for what gets checked, rogito timing for the sequence, the closing-cost breakdown for the line items, and cedolare secca at 21% for rental income. Open them before wiring a 10% compromesso on a €300,000 second home from abroad. The 2% and 9% registration tables repeat across the tax hub deliberately, so each page can be read on its own.
