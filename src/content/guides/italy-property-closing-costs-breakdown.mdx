---
title: "Italy Property Closing Costs: Complete 2026"
description: "Closing costs in Italy total 10-20%: notary 1-2.5%, agency 3-4% plus VAT, 2% or 9% registration tax, new-build VAT. Worked examples for foreign buyers."
pubDate: 2026-06-15
...
faq:
  - question: "What are the average closing costs when buying property in Italy?"
    answer: "A non-resident buying a second home should budget 10% to 15% all-in. The full spread across all cases runs 10% to 20%, depending on whether the property is a primary residence or second home, and whether it is purchased from a private seller or developer."
...
<TldrBlock text="TL;DR: Budget 10% to 15% all-in on a non-resident second home. Across all buyer types the spread is 10% to 20% of the purchase price. The exact costs depend on whether the property is a resale (subject to registration tax based on cadastral value) or a new-build (subject to VAT based on purchase price), and whether the buyer registers the property as a primary residence (prima casa) or second home. Key expenses include real estate agency commissions (3% to 4%), notary fees (1% to 2.5%), independent legal fees (1% to 2%), and professional technical surveys." />

## What Are the Total Closing Costs When Buying Property in Italy?

Total closing costs when buying property in Italy run 10% to 20% of the purchase price, and a non-resident second-home purchase through an agency sits at 10% to 15% all-in. These costs include real estate agency commissions of 3% to 4%, notary fees from 1% to 2.5%, independent legal fees of 1% to 2%, and government purchase taxes ranging from 2% to 9%.
...
| Declared price | Notary personal fee | Note |
|---|---|---|
| €300,000 | 2.0% to 2.5% | Plus 22% VAT |
| €2,000,000 | 1.0% to 1.2% | Sliding scale, plus 22% VAT |
...
<InlineCta text="Want the closing-cost stack modelled on a specific property before you sign a compromesso? We send a budget breakdown with the shortlist." linkText="Request shortlist" />
...
| Fee | Rate | When it falls due |
|---|---|---|
| Agency commission | 3% to 4%, up to 5% on luxury mandates | At the compromesso |
| Independent lawyer | 1% to 2% | Split across the preliminary stage |
| Compromesso registration | €200 fixed | Within 30 days of signing |
| Tax on the caparra | 0.50% of the deposit | With registration |
| Tax on any acconto | 3% of the advance | With registration |
...
>
> The buyer must investigate the official cadastral category of the Italian property before signing the preliminary contract (compromesso). If the property is registered under categories A/1 (stately homes), A/8 (villas), or A/9 (castles), the buyer cannot apply the two% registration tax (prima casa) exemption. Instead, the buyer will face a flat 9% registration tax on the cadastral value, even if it is the first and only property the buyer owns in Italy.

<InlineCta text="Not sure which fees apply to your route (resale, new-build, prima casa)? Ask for a line-by-line estimate on real listings." linkText="Get a free shortlist" />

## How Can Foreign Buyers Legally Minimize Closing Costs in Italy?

Foreign buyers can legally minimize closing costs by registering their main residency in Italy within 18 months to qualify for the two% primary residence registration tax. Buyers must also select the price-value mechanism (prezzo-valore) under Law 266 of 2005 to pay taxes based on the lower cadastral value.
