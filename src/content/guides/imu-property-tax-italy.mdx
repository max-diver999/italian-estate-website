...
The IMU property tax in Italy is an annual municipal levy on real estate under Legislative Decree 23/2011, with rates that typically range from 0.46% to 1.14% of cadastral value across 7,901 comuni. MORE Group models IMU before net yield on every foreign-buyer file in 2026.
...
| Rate band | 0.46% to 1.14% | Comune sets within caps |
...
Cadastral categories set IMU coefficients and 2026 municipal rates typically range from 0.46% to 1.14% on second homes, with luxury primary homes near 0.50% baselines plus €200 deductions on A/1, A/8, and A/9 stock. MORE Group checks October 28 rate publications before December saldo.
