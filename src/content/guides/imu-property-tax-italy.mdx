...
IMU calculation means multiplying revalued cadastral yield by 1.05, then by coefficient 160 for standard homes, then by municipal rates often near 1.06% on second homes in 2026. Uses Florence €950 yield examples producing about €1,692 annual tax at full-year ownership.
...
The IMU calendar means 50% acconto by June 16, 2026 and remaining saldo by December 16, 2026, unless owners pay 100% in June using prior-year rates then reconcile after October rate updates. Calendar both dates because comuni send no posted bills to foreign owners.
...
Late IMU means Ravvedimento Operoso penalties from 0.1% per day for 14 days up to 30% fines after comune audit, with assessments allowed until December 2031 on unpaid 2026 debts. Retains F24 receipts six years on foreign second-home lines showing codes 3918 and Belfiore routing. 2026
