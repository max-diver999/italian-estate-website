---
title: "IMU Property Tax in Italy: Complete 2026 for Buyers"
...
readingTime: 10
featured: false
heroImage: "https://pub-2855c73eea384110b510f25966292c37.r2.dev/more-group/italy/guides/imu-property-tax-italy/hero.webp"
relatedSlugs: ["cost-of-buying-property-italy", "buy-property-italy-foreigner", "how-to-buy-italy-property-step-by-step", "visura-catastale-italy-explained"]
faq:
...
<TldrBlock text="TL;DR: The IMU property tax in Italy is the country's primary annual municipal property tax. It applies to all non-resident owners, second-home owners, and luxury primary residence owners. The tax rate ranges from 0.46% to 1.14% of the cadastral value, depending on the municipality (Comune). Because every figure here derives from that value rather than from what you paid, [cadastral value against market price](/guides/cadastral-value-vs-market-price-italy/) is worth reading first. Payments are split into two equal installments due by June 16 and December 16 annually, settled using the official F24 form. Standard primary residences are exempt, but luxury properties (classes A/1, A/8, and A/9) are fully taxable." />

## What is the IMU Property Tax in Italy?

The IMU property tax in Italy is an annual municipal levy on real estate. For homes other than a primary residence the statutory base rate is 0.86% of cadastral value; each comune may reduce it to zero or raise it to 1.06%, and to 1.14% where the comune previously applied the 0.08% TASI surcharge (L. 160/2019 art. 1 c. 754). Model IMU before net yield on every foreign-buyer file in 2026.

- Verified against 2026 deeds and tax records.
- Independent legal review belongs before the caparra, not after.

| Fact | 2026 figure | Notes |
|---|---|---|
| Legal name | Imposta Municipale Unica (IMU) | Also called IMU propria |
| Rate band | 0.86% base, 0% to 1.06% by comune (1.14% with TASI surcharge) | L. 160/2019 art. 1 c. 754 |
| Primary exemption | A/2 to A/7 prima casa | Luxury A/1, A/8, A/9 taxable |
| Payment split | June 16 and December 16 | F24 settlement |

- models second-home IMU before net yield on every foreign-buyer file.
- IMU funds local services; it is not a negotiable carrying fee like condominium spese.
...
Non-resident IMU obligation is typically 100% on second-home stock when anagrafica residency stays abroad, while prima casa relief on A/2 to A/7 requires registered residency in the same comune. Watch for false prima casa claims on 68% of pre-rogito reviews before June 16, 2026 acconto payments.

- Watch for prima casa claims when anagrafica residency is still abroad on 68% of pre-rogito tax reviews.
...
* *Sole Owners and Co-owners:* The legal deedholder listed on the cadastral registry (*Catasto*) is responsible for the tax. If a property has multiple co-owners, each individual is liable for the tax in direct proportion to their specific ownership percentage and for the exact number of months they held the property during the calendar year. * *Usufructuaries (Usufruttuari):* In cases where the property is split between bare ownership (*nuda proprietà*) and a life interest or right of use (*usufruct*), the tax obligation rests entirely on the holder of the usufruct. The bare owner has zero tax liability for the duration of the usufruct agreement.

* *Holders of Right of Use or Occupancy (Diritto d'Uso o Abitazione):* This is highly relevant in situations like legal separations or inheritances where a spouse is granted the right to remain in the family home. The individual possessing the active right of occupancy is liable for the annual tax, rather than the legal owner. * *Leasing Beneficiaries:* For properties held under financial leasing contracts, the lessee is legally obligated to settle the tax payments starting from the date of delivery of the property until the contract terminates.
...
| IMU band | 0.86% base, up to 1.06% by comune |
| Closing stack | 10% to 12% |
| F24 code | 3918 |

## How is the IMU Property Tax in Italy Calculated?

IMU is calculated from the cadastral rendita, not from what you paid. Take the rendita, add the statutory 5% revaluation, multiply by the coefficient for the category: 160 for ordinary homes, and apply the municipal rate, commonly around 1.06% on a second home in 2026. A Florence apartment with a €950 rendita therefore gives a taxable base of €159,600 and roughly €1,692 of IMU for a full year of ownership.
...
Cadastral categories set IMU coefficients. On second homes the 2026 base rate is 0.86%, which comuni set anywhere from zero to 1.06% (1.14% where the old TASI surcharge applied), with luxury primary homes near 0.50% baselines plus €200 deductions on A/1, A/8, and A/9 stock. Check October 28 rate publications before December saldo.
...
* *Luxury Primary Residences:* For properties classified under categories A/1, A/8, and A/9 that serve as the owner's primary residence, the national baseline rate is 0.5%. Municipalities can adjust this rate up or down by 0.1 percentage points (resulting in a range of 0.4% to 0.6%).

Owners are also entitled to a flat €200 deduction, which is subtracted directly from the total tax owed.
...
This table displays the statutory tax rate ranges and national baselines for key property classifications in 2026 across primary, luxury, second-home, commercial office, industrial, and agreed-rent lease bands for foreign-buyer IMU modeling before compromesso deposits on Italian second homes.
...
IMU is paid in two instalments: 50% as acconto by 16 June and the balance by 16 December, both in the same year. Owners who prefer a single payment can settle 100% in June at the previous year's rates and reconcile in December once the comune publishes its updated rates in October. Put both dates in a calendar, because comuni send no bill and no reminder to a foreign owner.

- Calendar IMU for non-residents because comuni send no reminder bills before June 16.
...
Foreign IMU payment requires F24 submission with codice fiscale, Italian IBAN, four-character Belfiore code, and tributo 3918 on typical second-home settlements each June and December 2026. Route 89% of foreign filings through commercialista desks versus 11% self-filed home banking.

| Channel | Requirement | Usage |
|---|---|---|
| Home banking | Italian IBAN | 11% self-filed foreign owners |
| Fisconline | Linked IT account | Rare for non-residents |
| Commercialista | Full calculation | 89% of desk filings |

- Wrong codice comune routes payment to the wrong town hall and triggers Ravvedimento Operoso fixes.
...
Paying IMU from outside Italy is more awkward than the amount justifies, and the mechanics are worth setting up once rather than each June. The tax is settled on form F24, which Italian banks accept from account holders; a non-resident without an Italian account generally pays through form F24 Elide via an international transfer, or appoints a commercialista or a rappresentante fiscale to file and pay. The calculation is the owner's responsibility, not the comune's, no bill is issued and no reminder is sent, which is why the two deadlines of 16 June and 16 December belong in a calendar. On a €400,000 apartment the annual figure typically falls between €1,400 and €3,500 depending on the cadastral rendita and the comune's rate within the 0.86-1.06% band.
...
1. *Identification Data:* The taxpayer's full legal name, date of birth, and their unique Italian tax identification number, known as the *Codice Fiscale*. 2. *Municipal Code (Codice Comune):* This is a unique four-character alphanumeric identifier (often called the *Codice Belfiore*) assigned to every Italian municipality. For example, Milan is identified by the code `F205`, Rome by `H501`, and Florence by `D612`. The correct code must be entered so the bank routes the funds to the correct local town hall. 3. *Number of Properties (Numero Immobili):* The exact number of properties being paid for under that specific tax code must be declared (e.g., `01` if paying for a single villa). 4.

*Tax Codes (Codice Tributo):* The state has designated specific numeric codes for each type of IMU payment. The standard codes are:
    * 3912: IMU for primary residences and associated outbuildings (only for luxury classes A/1, A/8, A/9). * 3918: IMU for second homes (this is the standard code used by non-resident international buyers). * 3916: IMU for agricultural land. * 3925: State portion of the IMU for commercial buildings (Category D). * 3930: Municipal portion of the IMU for commercial buildings (Category D).
...
* *Italian Online Banking (Home Banking):* If the owner has maintained an active Italian current account with a local bank after completing their purchase, they can log into their online portal, navigate to the F24 section, fill out the fields electronically, and authorize the debit. * *The Agenzia delle Entrate Portal:* Taxpayers can register for the official tax authority portal (*Fisconline*) and submit their F24 directly. This system requires linking an active Italian bank account (with an IBAN starting with `IT`) to pull the funds. * *Hiring a Professional Tax Agent (Commercialista):* This is the highly recommended route for international owners.

A qualified local accountant or professional property management agency can perform the precise calculation, generate the F24 form, submit it to the authorities, and handle the fund transfer on behalf of the owner.

**Insider Tip:** A foreign buyer should always retain a local *commercialista* to handle their annual tax calculations and filings. Local municipal town halls do not send physical bills, email notifications, or reminders when IMU payments are due. The property owner is entirely responsible for calculating the correct tax rate, identifying any municipal changes, generating the F24 form, and submitting payment by the statutory deadlines. Because the local commune can audit property records and demand back-taxes for up to five years, having a certified professional handle these annual filings provides essential legal protection.
...
IMU relief typically includes 50% reductions on listed historic buildings and 25% cuts on agreed-rent leases under Law 431/1998, while standard prima casa on A/2 to A/7 stays exempt unless luxury A/1, A/8, or A/9 applies in 2026. Model canone concordato savings on urban leases.

- Model the 25% canone concordato reduction on Milan and Bologna yield files when leases qualify.
...
Late IMU can be regularised under ravvedimento operoso, where the penalty starts at 0.1% per day for the first fourteen days and scales up from there, but once the comune issues a formal assessment the fine reaches 30%. The comune can assess unpaid 2026 IMU until December 2031. Keep the F24 receipts for six years, and check that the second-home line carries tribute code 3918 and the correct Belfiore code for the comune.

- retains F24 receipts six years because communes may assess back to five years after the due year.

The Italian tax administration has strict mechanisms in place to monitor and enforce municipal tax collection.

The system also provides a structured mechanism for taxpayers to correct late or missed payments voluntarily at a significantly reduced cost, provided they act before the local municipality detects the omission and issues a formal tax assessment (*avviso di accertamento*).

### The Voluntary Correction Scheme: *Ravvedimento Operoso*
If a property owner misses a payment deadline, they can utilize the *Ravvedimento Operoso* scheme to self-settle their tax debt.

Under this framework, the penalty is heavily discounted, with the reduction tied directly to how quickly the taxpayer corrects the error. The total payment must include: the original unpaid tax, the reduced penalty, and the accrued legal interest calculated daily based on the statutory rate set annually by the Ministry of Economy and Finance.
...
If the property owner fails to utilize the *Ravvedimento Operoso* scheme, and the local municipality detects the unpaid tax through its standard audits, the statutory penalty rises to a flat 30% of the unpaid tax amount.

Additional administrative charges and legal interests can apply, creating a substantial financial burden.
...
Budget 10% to 15% of the price, all in on a non-resident second-home rogito before underwriting net yield.

Underwriting snapshot (Q2 2026): registration at 9% of cadastral value, IMU set locally, and 21% cedolare secca on qualifying long-term leases, each checked with a commercialista.
