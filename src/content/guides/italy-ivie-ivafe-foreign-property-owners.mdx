...
Underwriting snapshot: IVIE at 0.76% of statutory value and IVAFE at 0.2% on financial assets apply only once Italian tax residency begins, and they replace nothing — IMU on any Italian property continues alongside them, because IMU follows location rather than the owner's residence.
