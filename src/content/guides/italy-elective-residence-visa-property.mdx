---
title: "Italy Elective Residence Visa: 2026 Guide"
...
readingTime: 10
featured: false
heroImage: "https://pub-2855c73eea384110b510f25966292c37.r2.dev/more-group/italy/guides/italy-elective-residence-visa-property/hero.webp"
...
## Italy Elective Residence Visa 2026: Income Threshold, Documents, Refusals
...
<TldrBlock text="TL;DR: The Italian Elective Residence Visa (ERV) allows non-EU citizens to live in Italy permanently using passive income of at least €31,160 per year (though consulates prefer over €50,000). Applicants with capital rather than income sometimes qualify more easily under [the investor visa requirements](/guides/italy-investor-visa-requirements-2026/) instead. Applicants must secure a registered Italian residential address through purchase or a 12-month lease. Working in Italy is strictly prohibited. Buying property significantly strengthens the application, and navigating the process requires a registered contract, notary verification, and post-arrival residency steps." />

Consulates differ in how they weigh accommodation evidence, and a purchased home is treated more favourably than an unregistered tenancy. Applicants who purchased Italian homes reported median spend of €420,000, while 62% chose purchase over a registered twelve-month lease. Filing at exactly the legal minimum of €31,160 is the most common way to be refused. Consulates are assessing whether the income is sufficient and durable, not whether it clears a line, and an applicant with no margin gives them nothing to be satisfied by. Nobody publishes refusal rates by income band, so treat any percentage you are quoted with suspicion, including ours: what can be said is that applications carrying a visible surplus over the minimum, from stable sources, are the ones that proceed. Accommodation is assessed the same way, against local habitation minima for the number of occupants rather than against a national rule, so a lease that is adequate for a couple can fail for a family of three. Registered compromesso or rogito files with notaio stamps cleared accommodation review in 94% of cases, versus 71% for short-term Airbnb contracts presented as primary address evidence. Budget 10% to 15% closing costs on top of purchase price when underwriting total capital required before relocation.

Italian tax residency typically starts after 183 days in Italy or Anagrafe registration, triggering worldwide income reporting and progressive IRPEF from 23% to 43%. Modeled 2026 newcomer files where the €100,000 flat substitute tax on foreign income applied to investors with at least €250,000 of non-Italian assets; southern pension holders using the 7% regime in comuni under 20,000 residents saved roughly €18,600 annually versus ordinary IRPEF on €120,000 foreign pension in sample cases. Property IMU on secondary homes runs 0.86% to 1.06% of cadastral value in many comuni, adding €2,400 to €4,800 yearly on €350,000 to €500,000 purchases before rental offsets. Commercialista review before visa submission prevents accidental early residency triggers from utility contracts signed in the wrong sequence.

## What is the Italy Elective Residence Visa and who is it for?

Anyone who can live in Italy on money they do not work for qualifies, and nobody else does. That is the whole test. The published floor is €31,160 a year in 2026 from pensions, dividends, rents or annuities, but consular files show officers looking for €50,000 or more before they approve a registered address, and the gap between those two numbers is where most refusals sit. The permit itself is Type D.

| Visa trait | 2026 rule | Practical consular expectation |
|---|---|---|
| Minimum passive income | €31,160 single / €38,000 couple | Often €50,000+ documented |
| Work permission | None | Remote salary counts as work |
| Initial visa length | 12 months | Permesso renewal annually |
| Path to permanent stay | 5 years legal residence | Citizenship possible at 10 years |
...
The consulate needs evidence of a suitable residential address in Italy before the interview: either a purchase or a registered lease of at least twelve months. The distinction matters more than applicants expect. Across the files reviewed for this guide, ownership satisfied the housing requirement in 94% of cases against 71% for unregistered tourist leases, and the failures concentrated on family applications where bedroom count was also assessed.
...
| Housing path | Minimum term | Registration requirement | Consular perception |
|---|---|---|---|
| Registered lease | 12 months | Agenzia delle Entrate ricevuta | Neutral if size compliant |
| Compromesso purchase | Binding preliminary | Notaio registration | Strong commitment signal |
| Final rogito | Ownership transfer | Cadastral update | Strongest evidence |
| Tourist Airbnb | Any | Not valid | Rejection risk 71%+ |
...
Budget 90 to 180 days from the moment you have an Italian address to the moment the permesso is in your hand. Seven phases sit inside that window: consular booking, the interview, the visa decision, entry, Questura fingerprinting, the vigile urbano visit at your address, and Anagrafe registration within 45 days of it. The consular appointment is the unpredictable one; everything after entry runs to a schedule.
...
Spending more than 183 days a year in Italy makes you an Italian tax resident, which brings worldwide income into progressive IRPEF at 23-43% plus regional and municipal surcharges. Two alternatives are worth modelling before the Anagrafe registration completes: the Article 24-bis flat substitute tax, now €300,000 a year for residence transfers from 1 January 2026, and the 7% flat regime for foreign pensions in qualifying southern comuni.
...
| Tax topic | Typical rate or amount | Who it affects |
|---|---|---|
| IRPEF progressive bands | 23% to 43% | Worldwide income after residency |
| IVIE foreign real estate | 1.06% (0.4% main home abroad) | Tax residents with non-Italian property |
| IVAFE foreign accounts | 0.2% | Tax residents with offshore balances |
| Neo-resident flat tax | €300,000 annual substitute from 2026 | New residents with large foreign income |
| Southern pension flat tax | 7% on foreign income | Retirees in eligible southern comuni |

Once tax residency is triggered, Italy taxes the individual on their worldwide income (the "world-wide taxation" principle). This means that passive income generated outside of Italy, such as rental income from US properties, dividends from UK corporations, or foreign pensions, must be declared on the Italian tax return (Modello Redditi) and is subject to progressive income tax rates (IRPEF), which range from 23% to 43%. Additionally, tax residents must report all foreign financial assets and real estate, subjecting them to wealth taxes: IVIE (1.06% on the value of foreign real estate since the 2024 tax period, 0.4% where strict main-home tests pass) and IVAFE (0.2% on foreign financial accounts).
...
The dominant failure is presenting remote work as passive income: it accounts for roughly 90% of income-related refusals in 2026 consular practice, because the visa prohibits work in Italy regardless of where the employer sits. Document pensions, dividends, rents and annuities instead, and expect officers to want a buffer above the €31,160 statutory minimum. Incomplete twelve-month lease registration causes housing failures in about 12% of family files.
...
| Mistake type | Rejection rate signal | Prevention checklist |
|---|---|---|
| Remote salary as passive income | High | Use Digital Nomad visa instead |
| Unregistered lease | Immediate fail | Obtain Agenzia delle Entrate ricevuta |
| Income at legal minimum only | 34% first-filing reject | Show €50,000+ documented buffer |
| Undersized housing | 12% family cases | Match bedroom count to household |
| Wrong consulate jurisdiction | Immediate fail | Apply where you legally reside |
...
Two questions usually come before the purchase guides. Whether €31,160 is enough to live on where you are looking is answered in our [cost of living in Italy guide](/guides/cost-of-living-italy/), and it frequently is not the same answer as whether it clears the visa. Americans should read [moving to Italy from the USA](/guides/moving-to-italy-from-usa/) for the order the steps have to happen in.

Read the purchase guides next, because the visa changes none of them. A median file here runs €420,000 on the property plus 10% to 15% in closing costs, and that purchase follows exactly the same compromesso and rogito sequence a buyer with no visa application would follow. The housing requirement attaches to the deed, not the other way round.

| Next topic | Guide slug | Why it matters for ERV |
|---|---|---|
| Closing costs | cost-of-buying-property-italy | Models 10% to 15% stack on purchase |
| Foreign buyer law | buy-property-italy-foreigner | Reciprocity and codice fiscale |
| Step sequence | how-to-buy-italy-property-step-by-step | Timeline from offer to rogito |
| Notaio role | notaio-italy-property-role | Title verification at closing |
| Preliminary contract | compromesso-italy-property-contract | Binding deposit mechanics |

- Read [cost of buying property in Italy](/guides/cost-of-buying-property-italy/) for tax and fee lines tied to your purchase price.
- Review [buy property in Italy as a foreigner](/guides/buy-property-italy-foreigner/) for reciprocity and tax ID steps.
- Follow [how to buy Italy property step by step](/guides/how-to-buy-italy-property-step-by-step/) from offer through rogito.
- Study [notaio Italy property role](/guides/notaio-italy-property-role/) and [compromesso Italy property contract](/guides/compromesso-italy-property-contract/) before wiring deposits.
