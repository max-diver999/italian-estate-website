...
Gross yield is annual rent divided by purchase price, before IMU, cedolare secca, management and vacancy. Net yield in Italy typically lands one to three points below it, because IMU runs 0.86-1.06% of cadastral value and the flat rental tax takes 21% or 26% of gross with no deductions. A non-resident buyer should also carry the 10-15% closing stack into the entry price before either figure means anything.
...
Cedolare secca is a flat tax on gross Italian rental income that replaces progressive IRPEF on qualifying leases in 2026. Standard long leases are taxed at 21% of gross rent, or 10% on a qualifying canone concordato; short lets take 21% on one property of your choosing and 26% on a second. No expenses are deductible under either regime — not IMU, not maintenance, not management. Non-resident buyers budget 10% to 15% closing.
