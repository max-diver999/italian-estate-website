...
readingTime: 14
featured: false
heroImage: "https://pub-2855c73eea384110b510f25966292c37.r2.dev/more-group/italy/heroes/italy-rental-yield-guide-8c922bb8.webp"
relatedSlugs:
...
| The line you are modelling | Where it lands | What moves it |
|---|---|---|
...
Yield sits downstream of three other decisions, and this page assumes you have made them: what you are buying, where, and on what visa. Where it does not, the ground is covered elsewhere: [the Italian market as an investment case](/guides/italy-property-investment-guide/), [how a foreigner actually completes a purchase](/guides/buy-property-italy-foreigner/), and [what the purchase costs to complete](/guides/cost-of-buying-property-italy/). The tax layer that turns a gross figure into a net one is in [Italian property taxes for foreign buyers](/guides/italy-property-taxes-foreign-buyers-guide/), and whether a short let is even licensable at the address is in [Italy holiday let licensing](/guides/italy-holiday-let-licensing/).
An avvocato acting for you finds what agency reassurance does not. Visura catastale and conformità gaps surface after the wire transfer when nobody independent has looked for them before it.
