...
Yes, Canadians can buy property in Italy. The Canada-Italy reciprocity agreement grants full freehold ownership without residency, minimum investment thresholds, or regional quotas. The practical path runs through codice fiscale issuance at the Toronto or Montreal consulate, CAD-to-EUR conversion with documented SWIFT transfers, independent due diligence, compromesso signing, and rogito completion.

Budget 10-15% above the purchase price for closing costs, plan 50-60% cash equity if you want Italian mortgage financing, and model CRA T1135 foreign property reporting alongside Italian IMU and cedolare secca from day one.
...
Fixed rates near 3.2% to 3.8% at 50% to 60% LTV in mid-2026. Pre-qualifies before compromesso on financed tickets.
...
The split follows the same pattern as American demand. Tuscany takes roughly 14-15% of foreign enquiry, with Florence near €4,737 per sqm returning 4-7% gross. Puglia averages €1,422 per sqm and returns 5-8% on managed short lets — a materially different asset for materially less money.

Lake Como trades above €4,000 per sqm with thinner yield. Route Ontario buyers to Tuscany and Quebec enquiry toward Puglia value bands.
