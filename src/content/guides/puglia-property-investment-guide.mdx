...
Gross yield marketing typically means 5% to 8% on Puglia listings, but net cash flow after 21% cedolare secca, IMU, and 50% to 75% STR operating loads can fall near 1% on a €350,000 Ostuni trullo with 32 weeks occupancy. Model commercialista scenarios before comparing commune headline portal averages across Valle d'Itria.
...
Practical Puglia steps requires codice fiscale within 4 weeks, avvocato review before 10% compromesso wires, and conservative net-yield models using 21% non-resident tax on €24,500 gross STR income. Budget 10% to 12% closing costs plus €95,000 average restoration on typical €425,000 foreign buyer tickets in 2026.
...
- [Puglia vs Tuscany Property](/guides/puglia-vs-tuscany-property/) compares investment fundamentals directly.
