...
Yes. British nationals retain full freehold purchase rights in Italy in 2026 through the MAECI reciprocity tables, which the notaio checks as a matter of routine. What Brexit changed is not ownership but presence: a UK passport now allows 90 days in any 180 in the Schengen area, and owning a house adds none.

Treat the property track and the immigration track as two separate plans, and reconcile them before signing a compromesso or wiring a caparra.
...
Article 16 of the Civil Code grants a foreign national property rights in Italy only where their own country grants equivalent rights to Italians. Since 2021 the United Kingdom has sat in the reciprocity tables as a third country with confirmed equivalence, and the notaio verifies that entry before the rogito.

The check matters because a deed executed without it can be void — even where a caparra above €50,000 has already reached the seller's escrow account.
...
A 10% move in GBP/EUR shifts the sterling cost of a €500,000 Italian purchase by roughly £43,000-47,000 before any notary fee is counted. On a €400,000 coastal apartment that swing routinely exceeds the entire first year of net rental income. British buyers who fix the deposit tranche and the balance with forward contracts remove the largest single variable in the budget; those who do not are running an unhedged currency position alongside a property investment.
...
The Elective Residence Visa lets a UK owner stay beyond the 90-day Schengen cap, provided passive income clears the €31,160 statutory minimum — London consulates in practice look for materially more, often around €50,000, and no work is performed in Italy. Owning the property strengthens the application because it evidences accommodation, and a registered twelve-month lease serves the same purpose where the bedroom count matches the household.
...
A UK resident is taxed on worldwide income, so Italian rent must be reported at home even after Italy has taken its share — typically 21% cedolare secca on a long lease, or 21% and 26% across short-let units. On purchase, budget the 9% registration tax on a second home inside a 10-15% closing stack.

The most common HMRC trigger for British owners of Tuscan and Puglian property is a missing SA105 line where Italian tax was paid but never declared.
...
A UK passport holder may spend 90 days in any rolling 180-day window across the Schengen area, and Italian property ownership adds precisely zero days to that allowance, however many IMU bills and utility contracts are in your name. The rolling window catches people out more often than the 90-day figure does: days spent anywhere in Schengen count, not just days in Italy. Plan the long-stay visa separately from the purchase.
...
Match the ticket, the letting model and the hold period to a district that actually delivers them, rather than shopping generic centro listings with thin income support. Whichever scenario you choose, three numbers apply to every British file: 9% registration tax on a second home, 21% cedolare secca on qualifying leases, and a 10-15% non-resident closing stack that must be funded in euros before the rogito.
...
This guide is informational and does not replace advice from a notaio, an avvocato, an Italian commercialista or a UK tax adviser before a compromesso is signed. The MAECI reciprocity tables, the 9% registration tax, the 21% cedolare secca rate and the 90-day Schengen cap all change when law or treaty text is updated, and the notaio's check at rogito is the only one that binds.
