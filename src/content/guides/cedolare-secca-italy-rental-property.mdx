...
The trade is deductions against simplicity, and it turns on cost ratio. On €30,000 of gross rent, cedolare secca at 21% costs €6,300. IRPEF on the net figure can fall nearer €4,715 once costs exceed 30% of gross and the marginal rate stays at 23% — so high-maintenance property often does better outside the flat regime. High earners in the 43% bracket often prefer cedolare on gross. Runs break-even spreadsheets before income-focused compromesso.
...
Electing cedolare secca instead of IRPEF means choosing flat tax on gross when expenses stay below roughly 30% of rent and marginal IRPEF would exceed 21% to 26% on net collections in 2026. Concordato leases at 10% flat beat both when rent caps are acceptable. Watch for heavy renovation years for IRPEF when invoices exceed 35% of gross.
