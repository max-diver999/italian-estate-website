...
Cedolare versus IRPEF means trading deductible expenses for a flat cap where €30,000 gross rent at 21% cedolare costs €6,300 while IRPEF on net rent can fall near €4,715 when costs exceed 30% of gross and marginal rate stays at 23%. High earners in the 43% bracket often prefer cedolare on gross. Runs break-even spreadsheets before income-focused compromesso.
...
Operating costs under cedolare secca means an IMU charge between 0.86% and 1.06% of cadastral value, condominium spese at €100 to €400 monthly, and management at 10% to 30% of gross still reduce cash flow but not Italian income tax on rent. Commercialista fees run €800 to €2,500 yearly for non-residents. Stacks all lines in [how to calculate rental yield in Italy](/guides/how-to-calculate-rental-yield-italy/) models.
