...
A landlord living abroad elects the same 21% or 26% rates as an Italian resident, provided they hold a codice fiscale and register each lease with the Agenzia delle Entrate within 30 days of its start. Tax residency elsewhere does not block the election on Italian-source rent, because Italy taxes the property where it sits. The home-country overlay — US Schedule E, UK SA105 — is applied afterwards, with treaty credit for the Italian tax already paid on F24.
...
Cedolare secca caps the income tax, not the cost base. IMU at 0.86-1.06% of cadastral value, condominium spese of €100-400 a month, and management at 10-30% of gross all continue to reduce cash flow. What they no longer do is reduce the Italian tax bill, because none of them are deductible. Commercialista fees run €800 to €2,500 yearly for non-residents. Stacks all lines in [how to calculate rental yield in Italy](/guides/how-to-calculate-rental-yield-italy/) models.
