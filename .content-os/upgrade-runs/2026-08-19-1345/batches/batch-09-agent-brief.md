...
- `src/content/projects/tranio-puglia-masseria-new.mdx` (GEO 61, imp 0) — https://italian-estate.com/projects/tranio-puglia-masseria-new/
...
- `src/content/areas/milan-navigli.mdx` (GEO 62, imp 0) — https://italian-estate.com/areas/milan-navigli/
- `src/content/areas/potenza.mdx` (GEO 62, imp 0) — https://italian-estate.com/areas/potenza/
- `src/content/areas/termoli.mdx` (GEO 62, imp 0) — https://italian-estate.com/areas/termoli/
- `src/content/compare/bologna-vs-florence-property.mdx` (GEO 62, imp 0) — https://italian-estate.com/compare/bologna-vs-florence-property/
...
```bash
touch /Users/Maxim/Desktop/Cursor_ed/Бизнес/MORE_Group/italian-estate-website/.content-os/upgrade-runs/2026-08-19-1345/batches/batch-09.done
```
