...
> Запускать **только** если Максим уже сказал «ок, batch 7».
...
- `src/content/projects/lucca-villa-historic-renovation.mdx` (GEO 60, imp 0) — https://italian-estate.com/projects/lucca-villa-historic-renovation/
- `src/content/projects/prandina-navigli-milan.mdx` (GEO 60, imp 0) — https://italian-estate.com/projects/prandina-navigli-milan/
...
- `src/content/areas/matera.mdx` (GEO 61, imp 0) — https://italian-estate.com/areas/matera/
- `src/content/areas/pescara.mdx` (GEO 61, imp 0) — https://italian-estate.com/areas/pescara/
- `src/content/areas/urbino.mdx` (GEO 61, imp 0) — https://italian-estate.com/areas/urbino/
...
```bash
touch /Users/Maxim/Desktop/Cursor_ed/Бизнес/MORE_Group/italian-estate-website/.content-os/upgrade-runs/2026-08-19-1345/batches/batch-07.done
```
