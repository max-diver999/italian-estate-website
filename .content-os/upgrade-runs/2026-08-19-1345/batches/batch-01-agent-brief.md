...
> Запускать **только** если Максим уже сказал «ок, batch 1».
...
- `src/content/projects/coima-via-carcani-trastevere.mdx` (GEO 48, imp 0) — https://italian-estate.com/projects/coima-via-carcani-trastevere/
- `src/content/projects/lendlease-mind-milan.mdx` (GEO 54, imp 0) — https://italian-estate.com/projects/lendlease-mind-milan/
- `src/content/projects/ostuni-trulli-modern-villa.mdx` (GEO 54, imp 0) — https://italian-estate.com/projects/ostuni-trulli-modern-villa/
- `src/content/projects/meli-navigli-milan.mdx` (GEO 55, imp 0) — https://italian-estate.com/projects/meli-navigli-milan/
...
- `src/content/areas/turin.mdx` (GEO 56, imp 0) — https://italian-estate.com/areas/turin/
...
```bash
touch /Users/Maxim/Desktop/Cursor_ed/Бизнес/MORE_Group/italian-estate-website/.content-os/upgrade-runs/2026-08-19-1345/batches/batch-01.done
```
