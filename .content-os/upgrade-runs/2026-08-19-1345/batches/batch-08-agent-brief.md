...
> Запускать **только** если Максим уже сказал «ок, batch 8».
...
- `src/content/projects/bologna-bloom-living.mdx` (GEO 61, imp 0) — https://italian-estate.com/projects/bologna-bloom-living/
- `src/content/projects/matera-sassi-apartments.mdx` (GEO 61, imp 0) — https://italian-estate.com/projects/matera-sassi-apartments/
- `src/content/projects/potenza-centro-apartments.mdx` (GEO 61, imp 0) — https://italian-estate.com/projects/potenza-centro-apartments/
- `src/content/projects/taormina-sea-view-residence.mdx` (GEO 61, imp 0) — https://italian-estate.com/projects/taormina-sea-view-residence/
...
```bash
touch /Users/Maxim/Desktop/Cursor_ed/Бизнес/MORE_Group/italian-estate-website/.content-os/upgrade-runs/2026-08-19-1345/batches/batch-08.done
```
