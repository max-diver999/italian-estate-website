...
- `src/content/projects/rome-jubilee-centro-storico.mdx` (GEO 59, imp 0) — https://italian-estate.com/projects/rome-jubilee-centro-storico/
- `src/content/projects/sanremo-sea-view-apartments.mdx` (GEO 59, imp 0) — https://italian-estate.com/projects/sanremo-sea-view-apartments/
- `src/content/projects/sorrento-coastal-apartment.mdx` (GEO 59, imp 0) — https://italian-estate.com/projects/sorrento-coastal-apartment/
- `src/content/projects/innesto-milan-social-housing.mdx` (GEO 60, imp 0) — https://italian-estate.com/projects/innesto-milan-social-housing/
...
- `src/content/areas/chianti.mdx` (GEO 60, imp 0) — https://italian-estate.com/areas/chianti/
...
```bash
touch /Users/Maxim/Desktop/Cursor_ed/Бизнес/MORE_Group/italian-estate-website/.content-os/upgrade-runs/2026-08-19-1345/batches/batch-06.done
```
