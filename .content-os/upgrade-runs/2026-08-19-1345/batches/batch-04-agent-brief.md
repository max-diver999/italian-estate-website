...
- `src/content/projects/bellagio-villa-lake-view.mdx` (GEO 58, imp 0) — https://italian-estate.com/projects/bellagio-villa-lake-view/
- `src/content/projects/ostuni-lamia-chiavi-in-mano.mdx` (GEO 58, imp 0) — https://italian-estate.com/projects/ostuni-lamia-chiavi-in-mano/
- `src/content/projects/palermo-centro-renovation.mdx` (GEO 58, imp 0) — https://italian-estate.com/projects/palermo-centro-renovation/
- `src/content/projects/siena-country-villa-pool.mdx` (GEO 58, imp 0) — https://italian-estate.com/projects/siena-country-villa-pool/
- `src/content/projects/tranio-como-carate-urio-2br.mdx` (GEO 58, imp 0) — https://italian-estate.com/projects/tranio-como-carate-urio-2br/
...
```bash
touch /Users/Maxim/Desktop/Cursor_ed/Бизнес/MORE_Group/italian-estate-website/.content-os/upgrade-runs/2026-08-19-1345/batches/batch-04.done
```
