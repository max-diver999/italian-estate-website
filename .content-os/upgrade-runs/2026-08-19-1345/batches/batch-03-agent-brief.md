# Batch 3 — GEO rewrite (5 files)

> Запускать **только** если Максим уже сказал «ок, batch 3».
...
**Done marker:** `batches/batch-03.done`

---

## Project reviews (если есть в batch)

- `src/content/projects/florence-oltrarno-apartment.mdx` (GEO 57, imp 0) — https://italian-estate.com/projects/florence-oltrarno-apartment/
- `src/content/projects/milano-sesto-urban-regeneration.mdx` (GEO 57, imp 0) — https://italian-estate.com/projects/milano-sesto-urban-regeneration/
- `src/content/projects/ostuni-masseria-pool-apuliadeluxe.mdx` (GEO 57, imp 0) — https://italian-estate.com/projects/ostuni-masseria-pool-apuliadeluxe/
...
- `src/content/areas/taormina.mdx` (GEO 58, imp 0) — https://italian-estate.com/areas/taormina/
- `src/content/compare/italy-vs-greece-property-investment.mdx` (GEO 58, imp 0) — https://italian-estate.com/compare/italy-vs-greece-property-investment/
...
```bash
touch /Users/Maxim/Desktop/Cursor_ed/Бизнес/MORE_Group/italian-estate-website/.content-os/upgrade-runs/2026-08-19-1345/batches/batch-03.done
```
