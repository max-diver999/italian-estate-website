...
> Запускать **только** если Максим уже сказал «ок, batch 10» **и** fix-batch = 0 not-ready.
...
- `src/content/areas/bellagio.mdx` (GEO 66, imp 0) — https://italian-estate.com/areas/bellagio/
- `src/content/areas/carovigno.mdx` (GEO 66, imp 0) — https://italian-estate.com/areas/carovigno/
- `src/content/areas/portofino.mdx` (GEO 66, imp 0) — https://italian-estate.com/areas/portofino/
- `src/content/areas/scalea.mdx` (GEO 66, imp 0) — https://italian-estate.com/areas/scalea/
- `src/content/areas/sorrento.mdx` (GEO 66, imp 0) — https://italian-estate.com/areas/sorrento/
...
```bash
touch /Users/Maxim/Desktop/Cursor_ed/Бизнес/MORE_Group/italian-estate-website/.content-os/upgrade-runs/2026-08-20-1117/batches/batch-10.done
```
