...
> Запускать **только** если Максим уже сказал «ок, batch 3» **и** fix-batch = 0 not-ready.
...
- `src/content/projects/bliss-uptown-milan.mdx` (GEO 63, imp 0) — https://italian-estate.com/projects/bliss-uptown-milan/
- `src/content/projects/como-lakefront-residence.mdx` (GEO 63, imp 0) — https://italian-estate.com/projects/como-lakefront-residence/
- `src/content/projects/lecce-urbs20-villas.mdx` (GEO 63, imp 0) — https://italian-estate.com/projects/lecce-urbs20-villas/
- `src/content/projects/noto-baroque-masseria.mdx` (GEO 63, imp 0) — https://italian-estate.com/projects/noto-baroque-masseria/
- `src/content/projects/pescara-centro-apartments.mdx` (GEO 63, imp 0) — https://italian-estate.com/projects/pescara-centro-apartments/
...
```bash
touch /Users/Maxim/Desktop/Cursor_ed/Бизнес/MORE_Group/italian-estate-website/.content-os/upgrade-runs/2026-08-20-1117/batches/batch-03.done
```
