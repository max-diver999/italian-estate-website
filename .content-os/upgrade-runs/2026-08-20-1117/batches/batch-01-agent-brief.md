# Batch 1 — GEO rewrite (5 files)

> Запускать **только** если Максим уже сказал «ок, batch 1» **и** fix-batch = 0 not-ready.
...
**Done marker:** `batches/batch-01.done`
...
- `src/content/projects/tranio-rome-eur-apartment.mdx` (GEO 62, imp 0) — https://italian-estate.com/projects/tranio-rome-eur-apartment/
- `src/content/projects/unapavia-pavia-residential.mdx` (GEO 62, imp 0) — https://italian-estate.com/projects/unapavia-pavia-residential/
...
- `src/content/compare/italy-vs-portugal-property-investment.mdx` (GEO 58, imp 0) — https://italian-estate.com/compare/italy-vs-portugal-property-investment/
- `src/content/compare/italy-vs-france-property-investment.mdx` (GEO 61, imp 0) — https://italian-estate.com/compare/italy-vs-france-property-investment/
- `src/content/areas/ancona.mdx` (GEO 63, imp 0) — https://italian-estate.com/areas/ancona/
...
```bash
touch /Users/Maxim/Desktop/Cursor_ed/Бизнес/MORE_Group/italian-estate-website/.content-os/upgrade-runs/2026-08-20-1117/batches/batch-01.done
```
