# Batch 9 — GEO rewrite (5 files)

> Запускать **только** если Максим уже сказал «ок, batch 9» **и** fix-batch = 0 not-ready.
...
**Done marker:** `batches/batch-09.done`
...
- `src/content/projects/ancona-centro-apartments.mdx` (GEO 65, imp 0) — https://italian-estate.com/projects/ancona-centro-apartments/
- `src/content/projects/coima-guido-reni-rome.mdx` (GEO 65, imp 0) — https://italian-estate.com/projects/coima-guido-reni-rome/
- `src/content/projects/costa-smeralda-apartment.mdx` (GEO 65, imp 0) — https://italian-estate.com/projects/costa-smeralda-apartment/
- `src/content/projects/ostuni-rascina-villa-construction.mdx` (GEO 65, imp 0) — https://italian-estate.com/projects/ostuni-rascina-villa-construction/
- `src/content/projects/turin-crocetta-apartments.mdx` (GEO 65, imp 0) — https://italian-estate.com/projects/turin-crocetta-apartments/
...
```bash
touch /Users/Maxim/Desktop/Cursor_ed/Бизнес/MORE_Group/italian-estate-website/.content-os/upgrade-runs/2026-08-20-1117/batches/batch-09.done
```
