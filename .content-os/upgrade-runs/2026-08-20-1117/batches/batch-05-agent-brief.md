...
> Запускать **только** если Максим уже сказал «ок, batch 5» **и** fix-batch = 0 not-ready.
...
- `src/content/areas/perugia.mdx` (GEO 64, imp 0) — https://italian-estate.com/areas/perugia/
- `src/content/areas/polignano-a-mare.mdx` (GEO 64, imp 0) — https://italian-estate.com/areas/polignano-a-mare/
- `src/content/areas/rome-centro-storico.mdx` (GEO 64, imp 0) — https://italian-estate.com/areas/rome-centro-storico/
- `src/content/compare/turin-vs-milan-property.mdx` (GEO 64, imp 0) — https://italian-estate.com/compare/turin-vs-milan-property/
- `src/content/compare/venice-vs-milan-property-investment.mdx` (GEO 64, imp 0) — https://italian-estate.com/compare/venice-vs-milan-property-investment/
...
```bash
touch /Users/Maxim/Desktop/Cursor_ed/Бизнес/MORE_Group/italian-estate-website/.content-os/upgrade-runs/2026-08-20-1117/batches/batch-05.done
```
