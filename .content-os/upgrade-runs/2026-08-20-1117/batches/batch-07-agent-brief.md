# Batch 7 — GEO rewrite (5 files)

> Запускать **только** если Максим уже сказал «ок, batch 7» **и** fix-batch = 0 not-ready.
...
**Done marker:** `batches/batch-07.done`
...
- `src/content/projects/rapallo-sea-view-apartments.mdx` (GEO 64, imp 0) — https://italian-estate.com/projects/rapallo-sea-view-apartments/
- `src/content/projects/urbino-university-apartments.mdx` (GEO 64, imp 0) — https://italian-estate.com/projects/urbino-university-apartments/
...
- `src/content/areas/alba.mdx` (GEO 65, imp 0) — https://italian-estate.com/areas/alba/
- `src/content/areas/langhe.mdx` (GEO 65, imp 0) — https://italian-estate.com/areas/langhe/
- `src/content/areas/lecce.mdx` (GEO 65, imp 0) — https://italian-estate.com/areas/lecce/
...
```bash
touch /Users/Maxim/Desktop/Cursor_ed/Бизнес/MORE_Group/italian-estate-website/.content-os/upgrade-runs/2026-08-20-1117/batches/batch-07.done
```
