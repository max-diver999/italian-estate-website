# Batch 6 — GEO rewrite (5 files)

> Запускать **только** если Максим уже сказал «ок, batch 6» **и** fix-batch = 0 not-ready.
...
**Done marker:** `batches/batch-06.done`
...
- `src/content/projects/chianti-farmhouse-restoration.mdx` (GEO 64, imp 0) — https://italian-estate.com/projects/chianti-farmhouse-restoration/
- `src/content/projects/chieti-university-apartments.mdx` (GEO 64, imp 0) — https://italian-estate.com/projects/chieti-university-apartments/
- `src/content/projects/langhe-barolo-vineyard-property.mdx` (GEO 64, imp 0) — https://italian-estate.com/projects/langhe-barolo-vineyard-property/
- `src/content/projects/nunziare-vii-lusciano.mdx` (GEO 64, imp 0) — https://italian-estate.com/projects/nunziare-vii-lusciano/
- `src/content/projects/portofino-apartment-renovation.mdx` (GEO 64, imp 0) — https://italian-estate.com/projects/portofino-apartment-renovation/
...
```bash
touch /Users/Maxim/Desktop/Cursor_ed/Бизнес/MORE_Group/italian-estate-website/.content-os/upgrade-runs/2026-08-20-1117/batches/batch-06.done
```
