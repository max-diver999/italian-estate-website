...
> Запускать **только** если Максим уже сказал «ок, batch 2» **и** fix-batch = 0 not-ready.
...
- `src/content/projects/amalfi-ravello-villa.mdx` (GEO 63, imp 0) — https://italian-estate.com/projects/amalfi-ravello-villa/
...
- `src/content/areas/arezzo.mdx` (GEO 63, imp 0) — https://italian-estate.com/areas/arezzo/
- `src/content/areas/chieti.mdx` (GEO 63, imp 0) — https://italian-estate.com/areas/chieti/
- `src/content/areas/como.mdx` (GEO 63, imp 0) — https://italian-estate.com/areas/como/
- `src/content/compare/pescara-vs-chieti-property.mdx` (GEO 63, imp 0) — https://italian-estate.com/compare/pescara-vs-chieti-property/
...
```bash
touch /Users/Maxim/Desktop/Cursor_ed/Бизнес/MORE_Group/italian-estate-website/.content-os/upgrade-runs/2026-08-20-1117/batches/batch-02.done
```
