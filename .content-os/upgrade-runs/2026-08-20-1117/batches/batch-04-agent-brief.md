...
> Запускать **только** если Максим уже сказал «ок, batch 4» **и** fix-batch = 0 not-ready.
...
```bash
touch /Users/Maxim/Desktop/Cursor_ed/Бизнес/MORE_Group/italian-estate-website/.content-os/upgrade-runs/2026-08-20-1117/batches/batch-04.done
```
